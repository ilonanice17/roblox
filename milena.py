...
class RandomQuoteGenerator:
    ...
    def create_widgets(self):
        ...
        self.history_list = scrolledtext.ScrolledText(self.root, width=60, height=15, wrap=tk.WORD)
        ...
        tk.Button(btn_frame, text="Сохранить данные", command=self.save_data).pack(side=tk.LEFT, padx=5)
